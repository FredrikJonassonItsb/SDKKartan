...
export default function AuthoritiesTab() {
  ...
  const authorities = allOrgs?.filter((org) => org.type === "authority") || [];
  ...
  const handleDelete = async (id: number, name: string) => {
    ...
    try {
      ...
      toast.error("Kunde inte ta bort myndigheten");
    }
  };
  ...
  const handleSave = async (data: any) => {
    try {
      if (editingEntity) {
        ...
        toast.success("Myndigheten har uppdaterats");
      } else {
        ...
        toast.success("Myndigheten har skapats");
      }
      refetch();
    } catch (error) {
      toast.error(editingEntity ? "Kunde inte uppdatera myndigheten" : "Kunde inte skapa myndigheten");
      throw error;
    }
  };
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                {authorities.length} myndigheter i databasen
              </CardDescription>
            </div>
